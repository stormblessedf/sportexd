...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get appTitle => 'Ø³Ø¨ÙˆØ±ØµØ§Ù„';

  @override
  String get findSportPartner => 'Ø§Ø¨Ø­Ø« Ø¹Ù† Ø´Ø±ÙŠÙƒÙƒ Ø§Ù„Ø±ÙŠØ§Ø¶ÙŠ';
  ...
  @override
  String get emailHint => 'Ù…Ø«Ø§Ù„@Ø¨Ø±ÙŠØ¯.com';
  ...
  @override
  String get showPassword => 'Ø¥Ø¸Ù‡Ø§Ø± ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±';

  @override
  String get hidePassword => 'Ø¥Ø®ÙØ§Ø¡ ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±';
  ...
  @override
  String get chat => 'Ø§Ù„Ù…Ø­Ø§Ø¯Ø«Ø©';

  @override
  String get meetupNotFound => 'Ø§Ù„Ù„Ù‚Ø§Ø¡ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯';

  @override
  String get chatInfoNotFound =>
      'Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ù…Ø­Ø§Ø¯Ø«Ø© ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©';
  ...
  String get userInfoNotFound =>
      'Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©';

  @override
  String get eventInfoNotFound =>
      'Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ø­Ø¯Ø« ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©';

  @override
  String get infoNotFound => 'Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©';

  @override
  String get eventNotFound => 'Ø§Ù„Ø­Ø¯Ø« ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯';

  @override
  String get streamNotFound => 'Ø§Ù„Ø¨Ø« ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯';
  ...
  @override
  String get pastMeetups => 'Ø§Ù„Ø£Ø­Ø¯Ø§Ø« Ø§Ù„Ù…Ø§Ø¶ÙŠØ©';

  @override
  String get organizerCannotLeave =>
      'Ù„Ø§ ÙŠÙ…ÙƒÙ† Ù„Ù„Ù…Ù†Ø¸Ù… Ù…ØºØ§Ø¯Ø±Ø© Ø­Ø¯Ø«Ù‡ Ø§Ù„Ø®Ø§Øµ';

  @override
  String get notParticipant => 'Ù„Ù… ØªÙ†Ø¶Ù… Ø¥Ù„Ù‰ Ù‡Ø°Ø§ Ø§Ù„Ø­Ø¯Ø«';

  @override
  String get alreadyJoined =>
      'Ù„Ù‚Ø¯ Ø§Ù†Ø¶Ù…Ù…Øª Ø¨Ø§Ù„ÙØ¹Ù„ Ø¥Ù„Ù‰ Ù‡Ø°Ø§ Ø§Ù„Ø­Ø¯Ø«';

  @override
  String get eventFull => 'Ø§Ù„Ø­Ø¯Ø« Ù…Ù…ØªÙ„Ø¦';

  @override
  String get invalidTeamSelection => 'Ø§Ø®ØªÙŠØ§Ø± ÙØ±ÙŠÙ‚ ØºÙŠØ± ØµØ§Ù„Ø­';

  @override
  String get invalidPositionSelection =>
      'Ø§Ø®ØªÙŠØ§Ø± Ù…ÙˆÙ‚Ø¹ ØºÙŠØ± ØµØ§Ù„Ø­';

  @override
  String get positionTaken =>
      'Ù‡Ø°Ø§ Ø§Ù„Ù…ÙˆÙ‚Ø¹ Ù…Ø´ØºÙˆÙ„ Ø¨Ø§Ù„ÙØ¹Ù„. ÙŠØ±Ø¬Ù‰ Ø§Ø®ØªÙŠØ§Ø± Ù…ÙˆÙ‚Ø¹ Ø¢Ø®Ø±.';

  @override
  String get selectPositionForFootball =>
      'ÙŠØ¬Ø¨ Ø¹Ù„ÙŠÙƒ Ø§Ø®ØªÙŠØ§Ø± Ù…ÙˆÙ‚Ø¹ Ù„Ù„Ø§Ù†Ø¶Ù…Ø§Ù… Ø¥Ù„Ù‰ Ø­Ø¯Ø« ÙƒØ±Ø© Ø§Ù„Ù‚Ø¯Ù… Ù‡Ø°Ø§';

  @override
  String get sectionAccount => 'Ø§Ù„Ø­Ø³Ø§Ø¨';

  @override
  String get editProfileSubtitle => 'Ù‚Ù… Ø¨ØªØ­Ø¯ÙŠØ« Ù…Ø¹Ù„ÙˆÙ…Ø§ØªÙƒ';

  @override
  String get sectionPrivacy => 'Ø§Ù„Ø®ØµÙˆØµÙŠØ©';

  @override
  String get changePassword => 'ØªØºÙŠÙŠØ± ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±';

  @override
  String get changePasswordSubtitle => 'Ø­Ø§ÙØ¸ Ø¹Ù„Ù‰ Ø£Ù…Ø§Ù† Ø­Ø³Ø§Ø¨Ùƒ';

  @override
  String get privacySettings => 'Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„Ø®ØµÙˆØµÙŠØ©';

  @override
  String get privacySettingsSubtitle => 'Ù…Ù† ÙŠÙ…ÙƒÙ†Ù‡ Ø±Ø¤ÙŠØªÙƒØŸ';

  @override
  String get sectionNotifications => 'Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª';

  @override
  String get notificationSettingsSubtitle =>
      'Ù…Ø§ Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ø§Ù„ØªÙŠ ØªØ±ÙŠØ¯ ØªÙ„Ù‚ÙŠÙ‡Ø§ØŸ';

  @override
  String get sectionAppearance => 'Ø§Ù„Ù…Ø¸Ù‡Ø±';

  @override
  String get mapStyle => 'Ù†Ù…Ø· Ø§Ù„Ø®Ø±ÙŠØ·Ø©';

  @override
  String get appLanguage => 'Ù„ØºØ© Ø§Ù„ØªØ·Ø¨ÙŠÙ‚';

  @override
  String get appLanguageSubtitle => 'Ø§Ø®ØªØ± Ù„ØºØ© Ø§Ù„ØªØ·Ø¨ÙŠÙ‚.';

  @override
  String get sectionSupport => 'Ø§Ù„Ø¯Ø¹Ù…';

  @override
  String get helpSupport => 'Ø§Ù„Ù…Ø³Ø§Ø¹Ø¯Ø© ÙˆØ§Ù„Ø¯Ø¹Ù…';

  @override
  String get aboutApp => 'Ø­ÙˆÙ„';

  @override
  String get sectionAdmin => 'Ø§Ù„Ø¥Ø¯Ø§Ø±Ø©';

  @override
  String get adminActions => 'Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª Ø§Ù„Ù…Ø´Ø±Ù';

  @override
  String get adminActionsSubtitle =>
      'Ø£Ø¯ÙˆØ§Øª Ø§Ù„ØµÙŠØ§Ù†Ø© ÙˆØ§Ù„Ø¥Ø¯Ø§Ø±Ø©';

  @override
  String get adminRatingsRecalculateSuccess =>
      'ØªÙ… Ø¨Ù†Ø¬Ø§Ø­! ØªÙ… ØªØ­Ø¯ÙŠØ« Ø¬Ù…ÙŠØ¹ ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ†.';

  @override
  String get adminPartnershipMigrationSuccess =>
      'ØªÙ… Ø¨Ù†Ø¬Ø§Ø­! Ø§ÙƒØªÙ…Ù„Øª Ø¹Ù…Ù„ÙŠØ© ØªØ±Ø­ÙŠÙ„ Ø§Ù„Ø´Ø±Ø§ÙƒØ§Øª. ØªÙ…Øª Ø¥Ø¶Ø§ÙØ© Ø£Ø²ÙˆØ§Ø¬ Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ† Ù…Ù† Ø§Ù„ÙØ¹Ø§Ù„ÙŠØ§Øª Ø§Ù„Ø³Ø§Ø¨Ù‚Ø© ÙƒØ´Ø±ÙƒØ§Ø¡.';

  @override
  String get adminRecalculateButton => 'Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ø­Ø³Ø§Ø¨';

  @override
  String get adminDeleteImageLessButton =>
      'Ø­Ø°Ù Ø§Ù„ÙØ¹Ø§Ù„ÙŠØ§Øª Ø¨Ø¯ÙˆÙ† ØµÙˆØ±';

  @override
  String get adminPartnershipMigrationButton =>
      'Ø¨Ø¯Ø¡ ØªØ±Ø­ÙŠÙ„ Ø§Ù„Ø´Ø±Ø§ÙƒØ§Øª';

  @override
  String get adminMeetupRecalculateButton =>
      'Ø¥Ø¹Ø§Ø¯Ø© Ø­Ø³Ø§Ø¨ Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„ÙØ¹Ø§Ù„ÙŠØ§Øª';

  @override
  String get adminReliabilityRecalculateButton =>
      'ØªØ­Ø¯ÙŠØ« Ø¯Ø±Ø¬Ø§Øª Ø§Ù„Ù…ÙˆØ«ÙˆÙ‚ÙŠØ©';

  @override
  String get logout => 'ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø®Ø±ÙˆØ¬';

  @override
  String get logoutConfirmTitle => 'ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø®Ø±ÙˆØ¬';
  ...
  String get passwordChangeSoon =>
      'ØªØºÙŠÙŠØ± ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ± Ù‚Ø±ÙŠØ¨Ø§Ù‹!';
  ...
  @override
  String get helpSoon => 'ØµÙØ­Ø© Ø§Ù„Ù…Ø³Ø§Ø¹Ø¯Ø© Ù‚Ø±ÙŠØ¨Ø§Ù‹!';

  @override
  String get navFeed => 'Ø§Ù„Ø®Ù„Ø§ØµØ©';

  @override
  String get navChats => 'Ø§Ù„Ù…Ø­Ø§Ø¯Ø«Ø§Øª';

  @override
  String get navCreate => 'Ø¥Ù†Ø´Ø§Ø¡';

  @override
  String get navVenues => 'Ø§Ù„Ø£Ù…Ø§ÙƒÙ†';

  @override
  String get navProfile => 'Ø§Ù„Ù…Ù„Ù';

  @override
  String get navPhoto => 'ØµÙˆØ±Ø©';
  ...
  @override
  String get timeoutError => 'Timeout - please try again';
  ...
  @override
  String get mapStyleCityNightGoldName => 'خمر دافئ';

  @override
  String get mapStyleEnhancedName => 'رياضي (فاتح)';

  @override
  String get mapStyleDarkName => 'الوضع الداكن';

  @override
  String get mapStyleLightName => 'فاتح كلاسيكي';

  @override
  String get mapStyleMinimalName => 'بسيط';

  @override
  String get mapStyleCityNightGoldDesc =>
      'خلفية كريمية مع طرق بلون الطين وماء فيروزي هادئ';

  @override
  String get mapStyleEnhancedDesc => 'مظهر رياضي بدرجات خضراء';

  @override
  String get mapStyleDarkDesc => 'سمة داكنة للاستخدام الليلي';

  @override
  String get mapStyleLightDesc => 'خريطة كلاسيكية بألوان فاتحة';

  @override
  String get mapStyleMinimalDesc => 'مظهر بسيط ونظيف';
  ...
  @override
  String get gettingLocation => 'Ø¬Ø§Ø±Ù ØªØ­Ø¯ÙŠØ¯ Ø§Ù„Ù…ÙˆÙ‚Ø¹...';

  @override
  String get useCurrentLocation => 'Ø§Ø³ØªØ®Ø¯Ø§Ù… Ù…ÙˆÙ‚Ø¹ÙŠ Ø§Ù„Ø­Ø§Ù„ÙŠ';

  @override
  String get searchLocation => 'Ø§Ø¨Ø­Ø« Ø¹Ù† Ù…ÙˆÙ‚Ø¹...';

  @override
  String get shareYourExperienceHint => 'Ø´Ø§Ø±Ùƒ ØªØ¬Ø±Ø¨ØªÙƒ...';

  @override
  String get alreadyReviewed => 'Reviewed';

  @override
  String get chatListTitle => 'الدردشات';

  @override
  String get chatListSubtitle => 'دردشات الفعاليات والتطابقات';

  @override
  String get swipeInviteTitle => 'اسحب وادعُ';

  @override
  String get swipeInviteSubtitle =>
      'اسحب يمينا لإرسال دعوة رياضية عبر بريميوم.';

  @override
  String get loginToUseSwipeInvites =>
      'سجل الدخول لاستخدام نظام الدعوات بالسحب.';

  @override
  String get premiumActive => 'بريميوم مفعل';

  @override
  String get premiumLocked => 'بريميوم مقفل';

  @override
  String get swipePremiumRequired =>
      'يلزم بريميوم لإرسال الدعوات بالسحب يمينا.';

  @override
  String get swipeMatchCreated => 'تم التطابق. يمكنك بدء الدردشة الآن.';

  @override
  String get swipeInviteSent => 'تم إرسال الدعوة.';

  @override
  String get swipeInviteAccepted => 'تم قبول الدعوة.';

  @override
  String get swipeInviteRejected => 'تم رفض الدعوة.';

  @override
  String get noSwipeCandidates => 'لا يوجد مرشحون حاليا.';

  @override
  String get locationUnknown => 'الموقع غير متوفر';

  @override
  String get noBioText => 'هذا المستخدم لم يضف نبذة بعد.';

  @override
  String commonSportsCount(int count) {
    return '$count رياضات مشتركة';
  }

  @override
  String get swipePass => 'تخطي';

  @override
  String get swipeInvite => 'ادعُ';

  @override
  String get swipePremiumOnly => 'بريميوم';
  ...
  @override
  String get incomingInvitesTitle => 'الدعوات الواردة';

  @override
  String get noIncomingInvites => 'لا توجد دعوات واردة.';
  ...
  @override
  String get matchesTitle => 'التطابقات';
